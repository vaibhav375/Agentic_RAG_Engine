...
def write_results_md(results: list[dict], out_path: str = "RESULTS.md", calibration: dict | None = None,
    ...
    parts.append(
        ...
        "and is factually correct — a 3B *judge* mis-scores correct-but-elaborated claims, so "
        "the critic is the bottleneck, not the generator. Full diagnosis and fix path: "
